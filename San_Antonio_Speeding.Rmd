...
#mutated time to only get the hour because I want to look at the stops in a day not across dates. I also mutated the year date for my later filter. 
...
# the dataset was still extremely large and I could not get the gganimate to work so I narrowed my dataset down to only stops in 2018, which still also is a lot and takes awhile to create the map.
